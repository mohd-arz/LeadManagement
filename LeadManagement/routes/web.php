...
Route::get('/add_lead_page',[CrudController::class,'addLeadPage'])->name('addLeadPage');
Route::post('add_lead',[CrudController::class,'addLead'])->name('addLead');

//Editing Leads by Executive
Route::get('/edit_lead/{id}',[CrudController::class,'editLeadPage'])->name('editLeadPage');
...
Route::get('add_duplicate',[CrudController::class,'addDuplicate'])->name('addDuplicate');
